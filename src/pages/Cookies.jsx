    ...
    return(
        ...
        <section id="privacy-content">
            <div className="container">
                ...
                <p>Per informazioni più dettagliate sui cookie utilizzati da questo sito, ti invitiamo a consultare la nostra <a href="cookie_policy.html">Cookie Policy</a>.</p>
            </div>
        </section>
        </>
    )
