    ...
    return(
        ...
        <section id="cookie-content">
            <div className="container">
                ...
                <p>Per maggiori informazioni sulle nostre pratiche relative al trattamento dei dati personali, ti preghiamo di consultare la nostra <a href="privacy_policy.html">Privacy Policy</a>.</p>
            </div>
        </section>
        </>
    )
